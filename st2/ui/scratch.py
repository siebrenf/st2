...
#     ("total points of interest", "@points_of_interest"),
#     ("total asteroids", "@asteroids"),
#     ("", ""),  # white line
#     ("faction", "@faction"),
...
#
# catalogued_only_checkbox = Checkbox(
#     label="Catalogued systems only",
#     active=False,
#     sizing_mode="scale_both",
# )
# catalogued_only_checkbox.on_change("active", update_sector_figure)
#
# headquarter_checkbox = Checkbox(
#     label="Show headquarters",
#     active=True,
#     sizing_mode="scale_both",
# )
# headquarter_checkbox.on_change("active", update_sector_figure)
#
# gate_connection_checkbox = Checkbox(
#     label="Show gate connections",
#     active=True,
#     sizing_mode="scale_both",
# )
...
#
# # m = df["uncharted"].max()
# # uncharted_slider = RangeSlider(title="Uncharted", value=(0, m), start=0, end=m, step=1, sizing_mode="scale_both",)
...
#         color,
#         column(
#             catalogued_only_checkbox,
#             headquarter_checkbox,
#             gate_connection_checkbox,
#             sizing_mode="scale_both",
#         ),
#         sizing_mode="scale_both",
#     ),
...
#     # placeholder
#     MultiSelect(options=[], sizing_mode="scale_both"),
#     # width=220,
#     sizing_mode="scale_both",
# )
# controls = row(
...
# top_right = column(
#     # placeholder
#     figure(sizing_mode="scale_both"),  # width=700, height=500),
#     controls,
#     sizing_mode="scale_both",
# )
#
# top = row(top_left, top_right, sizing_mode="scale_both")
# bottom = row(
#     # placeholder
#     column(
...
# )
#
# layout = column(top, bottom, sizing_mode="scale_both")
#
